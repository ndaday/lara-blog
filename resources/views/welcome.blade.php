...
<head>
    ...
    <meta name="author" content="DDay">
    <meta name="description" content="lara blog">
...
<body class="bg-gray-500 font-sans leading-normal tracking-normal antialiased">
    <nav class="bg-white fixed w-full z-10 top-0">
        <div class="bg-white">
            <div class="flex flex-wrap items-center content-center py-4">
    ...
    <!--Header-->
    <div class="w-full m-0 p-0 bg-cover bg-bottom" style="background-image:url('https://source.unsplash.com/collection/1/800x600'); height: 60vh; max-height:460px;">
        <div class="container max-w-4xl mx-auto pt-16 md:pt-32 text-center break-normal">
            <!--Title-->
            <p class="dark:text-gray-500 font-extrabold text-3xl md:text-5xl">
                Lara Blog
            </p>
            <p class="text-xl md:text-2xl dark:text-gray-500">Welcome to my Blog</p>
        </div>
    </div>
    ...
    <div class="container px-4 md:px-0 max-w-6xl mx-auto -mt-32">
        ...
        <div class="mx-0 sm:mx-6">
                ...
                <div class="container mx-auto flex items-center">
                    ...
                    <div class="flex w-1/2 pl-4 text-sm">
                        <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                            <li class="mr-2">
                                <a class="inline-block py-2 px-2 dark:text-gray-500 no-underline hover:underline" href="/post">POST</a>
                            </li>
                            <li class="mr-2">
                                <a class="inline-block py-2 px-2 dark:text-gray-500 no-underline hover:underline" href="/about">Abou</a>
                            </li>
                    ...
                    <div class="flex w-1/2 justify-end content-center">
                        <a class="inline-block dark:text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="@twitter_handle" href="https://twitter.com/intent/tweet?url=#">
                        ...
                        <a class="inline-block dark:text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="#facebook_id" href="https://www.facebook.com/sharer/sharer.php?u=#">
                            <svg class="fill-current h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            ...
            <div class="bg-gray-500 w-full text-xl md:text-2xl text-gray-800 leading-normal rounded-t">
            ...
            <!--Author-->
            <div class="flex w-full items-center font-sans p-6 md:p-12">
